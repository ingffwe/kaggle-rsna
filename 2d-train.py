    ...
    for batch_idx, (X, y_frac,y_vert) in pbar:
        ...
        if batch_idx % 1000==0 and batch_idx!=0:
            ...
            if new_loss < best_loss:
                torch.save(model.state_dict(), f'../output/ckpt-2d/ENV2_1012_512_loss{new_loss:.4f}.tph')
                best_loss = new_loss
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('../output/ckpt-2d/ENV2_1012_512_loss0.4928.tph'))
    model = model.to('cuda')
